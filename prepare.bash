...
mariabackup --prepare --target-dir=$FULL_BACKUP_DIR 2>> $backupdir/prepare.log
...
do
    ...
    mariabackup --prepare --target-dir=$FULL_BACKUP_DIR --incremental-dir=$DIR 2>> $backupdir/prepare.log
done
...
do
    ...
    echo "Deleted uncompressed files for incremental $DIR, Run prepare script again if needed" >> $backupdir/prepare.log
done
